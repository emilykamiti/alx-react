...
describe('App Component', () => {
  // Shallow render the App component for each test
...
describe('App Component when isLoggedIn is true', () => {
  // Shallow render the App component with isLoggedIn prop set to true
...
describe('mapStateToProps function', () => {
  test('mapStateToProps function', () => {
    // Create an Immutable Map representing the Redux store state
    let state = fromJS({
      isUserLoggedIn: true,
      isNotificationDrawerVisible: true,
    });

    // Call the mapStateToProps function and retrieve the result
