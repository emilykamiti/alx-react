...
describe("test uiReducer function", () => {
  // Test case: uiReducer returns state equals the initial state when no action is passed
  ...
  // Test case: uiReducer returns state equals the initial state when action SELECT_COURSE is passed
  ...
  // Test case: uiReducer returns state equals the initial state when action DISPLAY_NOTIFICATION_DRAWER is passed
  ...
  // Test case: uiReducer correctly changes the isUserLoggedIn property when action LOGIN_FAILURE is passed
  ...
  // Test case: uiReducer correctly changes the isUserLoggedIn property when action LOGOUT is passed
